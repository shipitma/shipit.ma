...
INSERT INTO purchase_requests (id, user_id, date, status, total_amount, items_cost, shipping_fee, service_fee, processing_fee, taxes, admin_notes, created_at) VALUES
('PR-2025-001', user_id, CURRENT_DATE - INTERVAL '15 days', 'completed', 2899.00, 2799.00, 50.00, 28.00, 14.00, 8.00, 'iPhone 15 Pro Max et AirPods Pro livrés avec succès', CURRENT_DATE - INTERVAL '15 days'),
('PR-2025-002', user_id, CURRENT_DATE - INTERVAL '10 days', 'purchasing', 1899.00, 1799.00, 50.00, 18.00, 9.00, 23.00, 'MacBook Air M2 en cours d\'achat', CURRENT_DATE - INTERVAL '10 days'),
('PR-2025-003', user_id, CURRENT_DATE - INTERVAL '8 days', 'pending_review', 1599.00, 1499.00, 50.00, 15.00, 7.50, 28.50, 'Samsung Galaxy S24 Ultra - En cours de vérification', CURRENT_DATE - INTERVAL '8 days'),
('PR-2025-004', user_id, CURRENT_DATE - INTERVAL '5 days', 'pending_review', 899.00, 899.00, NULL, NULL, NULL, NULL, 'Nike Air Jordan 1 - En cours de vérification', CURRENT_DATE - INTERVAL '5 days'),
('PR-2025-005', user_id, CURRENT_DATE - INTERVAL '3 days', 'pending_review', 1299.00, 1299.00, NULL, NULL, NULL, NULL, 'PlayStation 5 + manettes - Vérification des stocks', CURRENT_DATE - INTERVAL '3 days'),
('PR-2025-006', user_id, CURRENT_DATE - INTERVAL '1 day', 'pending_review', 599.00, 599.00, NULL, NULL, NULL, NULL, 'Apple Watch Series 9 - Nouvelle demande', CURRENT_DATE - INTERVAL '1 day');
...
('PR-2025-001', 'Achat Confirmé', CURRENT_DATE - INTERVAL '14 days', '16:45:00', true, 'Achat confirmé, procédure d\'achat', CURRENT_DATE - INTERVAL '14 days'),
...
('PR-2025-002', 'Achat Confirmé', CURRENT_DATE - INTERVAL '9 days', '15:20:00', true, 'Achat confirmé, procédure d\'achat', CURRENT_DATE - INTERVAL '9 days'),
...
-- PR-2025-003 timeline (Pending Review)
...
('PR-2025-003', 'En Révision', CURRENT_DATE - INTERVAL '8 days', '14:30:00', false, 'Administrateur vérifie la disponibilité', CURRENT_DATE - INTERVAL '8 days'),
